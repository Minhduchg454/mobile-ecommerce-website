  ...
  const handleSubmit = useCallback(async () => {
    ...
    if (isRegister) {
      ...
      if (response.success) {
        ...
        Swal.fire(
          "Oops!",
          response.mes || response.error || "Đăng ký thất bại!",
          "error"
        );
      }
    } else {
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#00afff] relative overflow-hidden">
      ...
      <div className="w-full max-w-md p-8 bg-white rounded-2xl shadow-2xl flex flex-col items-center z-10">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full py-2 mt-2 bg-cyan-600 hover:bg-cyan-700 text-white font-semibold rounded shadow transition-all"
          >
