    ...
    return (
        <div className='w-full flex flex-col gap-4 relative'>
            ...
            <div className='p-4 border-b bg-gray-100 flex justify-between items-center right-0 left-[327px] fixed top-0'>
                <h1 className='text-3xl font-bold tracking-tight'>CẬP NHẬT THÔNG TIN SẢN PHẨM</h1>
            ...
            <div className='p-4'>
                <form onSubmit={handleSubmit(handleUpdateProduct)}>
                    ...
                    <div className='flex flex-col gap-2 mt-8'>
                        <label className='font-semibold' htmlFor="thumb">Ảnh đại diện sản phẩm</label>
                        <input
                            type="file"
                            id="thumb"
                            {...register('thumb')}
                    ...
                    <div className='flex flex-col gap-2 mt-8'>
                        <label className='font-semibold' htmlFor="products">Ảnh sản phẩm</label>
                        <input
                            type="file"
                            id="products"
                            multiple
                    ...
                    <div className='my-6'><Button type='submit'>Xác nhận</Button></div>
                </form>
            </div>
        </div>
    )
