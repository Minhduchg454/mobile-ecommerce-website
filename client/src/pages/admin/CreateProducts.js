                ...
                <form onSubmit={handleSubmit(handleCreateProduct)}>
                    ...
                    <div className='w-full my-6 flex gap-4'>
                        ...
                        <InputForm
                            ...
                            style='flex-auto'
                            placeholder='Só lượng sản phẩm mới'
                            type='number'
                        />
                        <InputForm
                            label='Màu'
                    ...
                    <div className='flex flex-col gap-2 mt-8'>
                        <label className='font-semibold' htmlFor="thumb">Ảnh đại diện của sản phẩm</label>
                        <input
                            type="file"
                            id="thumb"
                    ...
                    <div className='my-6'><Button type='submit'>Thêm sản phẩm</Button></div>
                </form>
            </div>
        </div>
    )
