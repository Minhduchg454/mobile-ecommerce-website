        ...
        history: [
            {
              ...
              2. Bạn sẽ là người hướng dẫn người sử dụng thực hiện các chức năng của trang web khởi nghiệp
              3. Lưu ý nói vừa đủ.
              4. Chức năng đăng ký web citaa không có gửi mã OTP.
              5. Chức năng phản hồi của citaa nằm ở mục kết nối trên thanh điều hướng; nhập thông tin vào form và nhấn gửi.
                    ...
                    <div className="bg-blue-600 text-white p-4 rounded-t-xl flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                            ...
                            <div>
                                ...
                                <p className="text-xs opacity-80">Thường trả lời sau vài phút</p>
                            </div>
                        </div>
