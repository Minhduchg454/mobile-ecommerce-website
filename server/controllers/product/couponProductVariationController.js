...
const createCouponProductVariation = asyncHandler(async (req, res) => {
    const { coupon, variation } = req.body;
    ...
    const response = await CouponProductVariation.create({ coupon, variation });
...
const updateCouponProductVariation = asyncHandler(async (req, res) => {
    ...
    const response = await CouponProductVariation.findByIdAndUpdate(id, req.body, { new: true });
