...
async function getCurrentWeather(location) {
  ...
  if (
    ...
    const result = {
      ...
      temperature: "28",
      unit: "celsius",
      conditions: "Nhiều mây, có mưa rào",
    };
    ...
    const errorResult = {
      error: "Không tìm thấy thông tin thời tiết cho địa điểm này.",
      location: location,
    };
