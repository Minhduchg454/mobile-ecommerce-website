...
exports.createCart = asyncHandler(async (req, res) => {
    ...
    const cart = await ShoppingCart.create({ userId: mongoose.Types.ObjectId(userId), totalPrice });
...
exports.updateCart = asyncHandler(async (req, res) => {
    ...
    const updated = await ShoppingCart.findByIdAndUpdate(id, updateData, { new: true });
