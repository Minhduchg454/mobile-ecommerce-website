...
// Lấy toàn bộ biến thể theo productId
router.get("/by-product/:productId", ctrls.getProductVariationsByProductId);
...
router.put(
  "/uploadImage/:pvid",
  uploadCloud.array("images", 10),
  ctrls.uploadImagesProductVariation
);
