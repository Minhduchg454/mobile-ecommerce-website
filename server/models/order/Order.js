...
orderSchema.pre('save', async function (next) {
    ...
    const ShippingProvider = mongoose.models.ShippingProvider || mongoose.model('ShippingProvider');
    ...
    try {
        ...
        const shippingProviderExists = await ShippingProvider.findById(this.shippingProviderId);
